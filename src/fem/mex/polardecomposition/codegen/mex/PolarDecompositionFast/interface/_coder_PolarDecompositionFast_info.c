 ...
 *
 * _coder_PolarDecompositionFast_info.c
 *
...
/* Include files */
#include "_coder_PolarDecompositionFast_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"PolarDecompositionFast"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString(
          (const char_T *)"/home/brandon/Documents/MATLAB/SorotokiCode/src/fem/"
                          "mex/polardecomposition/PolarDecompositionFast.m"));
  emlrtSetField(xEntryPoints, 0, (const char_T *)"TimeStamp",
                emlrtMxCreateDoubleScalar(738569.39304398152));
  xResult =
...
/* End of code generation (_coder_PolarDecompositionFast_info.c) */
