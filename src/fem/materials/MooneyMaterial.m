...
%---------------------------------------------------------------------- set
function y = getContactReaction(MooneyMaterial)
    y = MooneyMaterial.C10*MooneyMaterial.Rr; 
end
%---------------------------------------------------------------------- set
...
J3E = W5*I3E;
%
P = MooneyMaterial.C10*(J1-3) + MooneyMaterial.C01*(J2-3) + ...
    0.5*MooneyMaterial.K*(J3 - 1)^2;
