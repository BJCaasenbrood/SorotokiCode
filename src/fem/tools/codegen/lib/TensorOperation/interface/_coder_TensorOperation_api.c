...
#include "_coder_TensorOperation_mex.h"
...
static boolean_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *Arg,
  ...
  const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(Arg), &thisId);
...
void TensorOperation_api(const mxArray * const prhs[3], int32_T nlhs, const
  mxArray *plhs[1])
{
  real_T (*T)[36];
  real_T (*A)[9];
  ...
  Arg = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "Arg");

  /* Invoke the target function */
  TensorOperation(*A, *B, Arg, *T);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*T);
}

void TensorOperation_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  TensorOperation_xil_terminate();
}

void TensorOperation_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void TensorOperation_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_TensorOperation_api.c) */
