...
void minv_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *plhs[1])
{
  real_T (*X)[9];
  real_T (*A)[9];
  ...
  X = (real_T (*)[9])mxMalloc(sizeof(real_T [9]));
...
/* End of code generation (_coder_minv_api.c) */
