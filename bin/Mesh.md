...
A signed distance functions (SDF) passes spatial coordinates in $$\mathbb{R}^2$/$\mathbb{R}^2$$ and returns a signed value representing the shortest distance to a spatial domain $$\Omega$$.
