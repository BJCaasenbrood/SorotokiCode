...
mdl = setupSoftRobot(mdl,50e-5,25,500);
mdl = mdl.set('Tdomain',5); 

%% generate trajectory
x = linspace(0,20,1e3).';
mdl.Xspline = [x,0.02*sin(x)+0.07];
...
%text(p(1),p(2),p(3),'\textbf{$g_d$}','interpreter','latex','fontsize',16);
