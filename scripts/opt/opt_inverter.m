...
%% show generated mesh
fem = Fem(msh,'VolumeInfill',0.4,'Penal',4,'FilterRadius',0.15,...
...
fem = fem.AddConstraint('Load',fem.FindNodes('NW'),[-1,0]);
%fem = fem.AddConstraint('Spring',fem.FindNodes('NW'),[1e-3,0]);
fem = fem.AddConstraint('Output',fem.FindNodes('NE'),[1,0]);
fem = fem.AddConstraint('Spring',fem.FindNodes('NE'),[1e-6,0]);
